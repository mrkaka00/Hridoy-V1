...
module.exports = {
        ...
        langs: {
                bn: {
                        noLink: " একটি সঠিক ভিডিও লিঙ্ক দাও অথবা লিঙ্কে রিপ্লাই দাও! 🔗",
                        success: "𝐇𝐞𝐫𝐞'𝐬 𝐲𝐨𝐮𝐫 𝐝𝐨𝐰𝐧𝐥𝐨𝐚𝐝 𝐯𝐢𝐝𝐞𝐨 𝐛𝐚𝐛𝐲 <😘",
                        error: " ডাউনলোড করতে সমস্যা হয়েছে: %1। প্রয়োজনে Contact Kakashi।"
                },
                en: {
                        noLink: "please provide a valid video link or reply to one! 🔗",
                        success: "𝐇𝐞𝐫𝐞'𝐬 𝐲𝐨𝐮𝐫 𝐝𝐨𝐰𝐧𝐥𝐨𝐚𝐝 𝐯𝐢𝐝𝐞𝐨 𝐛𝐚𝐛𝐲 <😘",
                        error: "× Failed to download: %1. Contact Kakashi for help."
                },
                vi: {
                        noLink: "× Cưng ơi, vui lòng cung cấp liên kết video hợp lệ! 🔗",
                        success: "𝐇𝐞𝐫𝐞'𝐬 𝐲𝐨𝐮𝐫 𝐝𝐨𝐰𝐧𝐥𝐨𝐚𝐝 𝐯𝐢𝐝𝐞𝐨 𝐛𝐚𝐛𝐲 <😘",
                        error: "× Lỗi tải xuống: %1. Liên hệ Kakashi để hỗ trợ."
                }
        },
